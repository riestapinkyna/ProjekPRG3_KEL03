...
public class CRUDDokter {
    ...
    public CRUDDokter() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.equals("") || alamat.equals("") || no.equals("")) {
                    ...
                    try {
                        ...
                        String sql2 = "EXEC sp_InputDokter ?,?,?,?";
        ...
        editButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (id.equals("") || nama.equals("") || alamat.equals("") || no.equals("")) {
                    ...
                    try {
                        String query = "UPDATE tblDokter SET nama=?, alamat=?, no_telepon = ? WHERE id_dokter =?";
        ...
        hapusButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(dialogResult == 0) {
                    try {
                        String query = "DELETE FROM tblDokter WHERE id_dokter=?";
                        connection.pstat = connection.conn.prepareStatement(query);
                        connection.pstat.setString(1, id);
                        connection.pstat.executeUpdate(); //insert ke database
                        connection.pstat.close(); //menutup koneksi db
    ...
    public void showByID(){
        ...
        try {
            ...
            String query = "SELECT * FROM caridokter ('"+id+"')";
    ...
    public void showByNama(){
        ...
        try {
            connection.stat = connection.conn.createStatement();
            String query = "SELECT * FROM tblDokter WHERE  nama LIKE '%" + nama + "%'";
            connection.result = connection.stat.executeQuery(query);
    ...
    public void showSemuaData(){
        ...
        try {
            connection.stat = connection.conn.createStatement();
            String query = "SELECT * FROM tblDokter";
            connection.result = connection.stat.executeQuery(query);
    ...
    public void autokode() {
        try {
            String sql = "SELECT * FROM tblDokter ORDER BY id_dokter desc";
            connection.stat = connection.conn.createStatement();
            connection.result = connection.stat.executeQuery(sql);
            if (connection.result.next()) {
                id = connection.result.getString("id_dokter");
