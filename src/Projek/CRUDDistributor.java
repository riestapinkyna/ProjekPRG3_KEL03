...
public class CRUDDistributor {
    ...
    public CRUDDistributor()
    {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.equals("") || alamat.equals("") || no.equals("")) {
                    ...
                    try {
                        ...
                        String sql2 = "EXEC sp_InputDistributor ?,?,?,?";
        ...
        editButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (id.equals("") || nama.equals("") || alamat.equals("") || no.equals("")) {
                    ...
                    try {
                        String query = "UPDATE tblDistributor SET nama=?, alamat=?, no_telp = ? WHERE id_distributor =?";
        ...
        hapusButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(dialogResult == 0) {
                    try {
                        String query = "DELETE FROM tblDistributor WHERE id_distributor=?";
                        connection.pstat = connection.conn.prepareStatement(query);
                        connection.pstat.setString(1, id);
                        connection.pstat.executeUpdate(); //insert ke database
                        connection.pstat.close(); //menutup koneksi db
    ...
    public void showByID(){
        ...
        try {
            ...
            String query = "SELECT * FROM caridistributor('"+id+"')";
    ...
    public void showByJenis(){
        ...
        try {
            connection.stat = connection.conn.createStatement();
            String query = "SELECT * FROM tblDistributor WHERE  nama LIKE '%" + nama + "%'";
            connection.result = connection.stat.executeQuery(query);
    ...
    public void autokode() {
        try {
            String sql = "SELECT * FROM tblDistributor ORDER BY id_distributor desc";
            connection.stat = connection.conn.createStatement();
            connection.result = connection.stat.executeQuery(sql);
            if (connection.result.next()) {
                id = connection.result.getString("id_distributor");
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("CRUD Distributor");
        frame.setContentPane(new CRUDDistributor().jpUtama);
